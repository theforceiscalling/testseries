"""
Django settings for tscore project.
...
SECRET_KEY = 'django-insecure-p3krc5kin*60#ewq4-%%qi4hf&4lp$b!rozd_u8kd7u04)j5&i'
...
WSGI_APPLICATION = 'tscore.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_FROM = 'support@testseries.online'
