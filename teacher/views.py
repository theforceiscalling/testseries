...
def index(request):
    if request.user.is_teacher or request.user.is_superuser or request.user.is_staff:
        ...
        messages.warning(request, "You do not have a verified teacher account. If you want to access this page you can request to convert your Student account into Teacher account from link below.")
